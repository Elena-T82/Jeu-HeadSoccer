...
public class ScriptJoueur : MonoBehaviour
{
    ...
    void Update()
    {
        //Controle de mouvement du joueur1
        ...
        if (Input.GetKeyDown(KeyCode.Z)) //GetKeyDown : si la key est appuyée une fois
        {
            if (SautPossible)
            {
        ...
        if (Input.GetKeyUp(KeyCode.D)) //GetKeyUp : quand la key est relachée
        {
    ...
    public void getFrontiere(Vector3 p_frontiere) //frontiere de l'écran
    {
